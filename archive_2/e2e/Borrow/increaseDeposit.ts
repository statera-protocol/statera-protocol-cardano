import { mConStr1, mConStr3, stringToHex } from "@meshsdk/core";
...
const totalDepositAmountInt = (depositAmountInt * 1000000) + Number(userDepositUtxos[0].output.amount[0].quantity)
