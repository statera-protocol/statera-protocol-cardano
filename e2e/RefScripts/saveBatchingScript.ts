import { applyCborEncoding, mConStr0, mPubKeyAddress, serializePlutusScript } from "@meshsdk/core";
import { txBuilder, usdmUnit, wallet1, wallet1Address, wallet1SK, wallet1Utxos, wallet1VK } from "../setup.js";
import { BatchingValidatorScript } from "../Batching/validators.js";
...
console.log("Save batching script:", txHash);
