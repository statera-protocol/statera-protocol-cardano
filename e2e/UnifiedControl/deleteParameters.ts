...
import { multiSigAddress, multiSigCbor, multiSigUtxos, StPparamsAssetName, txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1Utxos, wallet2 } from "../setup.js";
...
console.log("Delete Parameters tx hash:", txHash);
